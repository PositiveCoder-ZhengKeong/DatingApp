...
namespace DatingApp.API.Controllers
{
    ...
    {
        // IOptions to access the data in the starup.cs
        ...
        public async Task<IActionResult> SetMainPhoto(int userId, int id)
        {
            ...
            // check if the user is updating his own photo OR
            // check whether the photo is exist
            ...
            var photoFromRepo = await _repo.GetPhoto(id);
            // check if the photo is already main
